...
function RecentProjects({ locale }: { locale: string }) {
  ...
  return (
    <div className="py-20">
      ...
      <div
        className={`${styles.pinContainerWrapper} mt-10 flex flex-wrap items-center justify-center gap-x-16 gap-y-12 p-4 max-lg:gap-y-10 max-md:gap-y-8 max-sm:mt-4 max-sm:gap-y-6`}
      >
